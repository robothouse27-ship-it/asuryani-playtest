...
# data/legion-traits.json.  Usage: PW='Erebus' bash build/ship_legion_traits.sh
set -euo pipefail
cd "$(dirname "$0")/.."
...
for d in data_*/; do
  ...
  PW="${PW:-Erebus}" node build/encrypt_army.js "data_${aid}/bundle.json" "app/data.${aid}.enc.js"
done
